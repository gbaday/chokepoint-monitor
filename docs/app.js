...
const DICTIONARY = [
  ...
  ["Spread",          "Cross-sec z of average(TTF-HH β, JKM-HH β); each β from a separate bivariate OLS (stock ~ spread). Scatter toggles between individual betas.", "180-day bivariate regressions (univariate per spread to avoid multicollinearity).", "High torque to widening global spreads.", "Decoupled from spread cycle."],
  ...
  ["Growth",          "Cross-sec z of forward revenue growth (clipped ±3σ).",                       "Bloomberg SALES_GROWTH; yfinance growth_estimates as fallback.",             "Faster revenue growth.",               "Decline expected."],
